...
//   }, [flightquery.returnDate,flightquery.departureDate, flightquery.destination, flightquery.departure]);
  ...
  />
    ...
    setVisible={setVisible}>
    <TextInput placeholder='Enter city or airport' onChangeText={input=>handleSearch(input)} value={flightquery.destination != null ? flightquery.destination: flightquery.searchValue}/>
{/* 
    {
