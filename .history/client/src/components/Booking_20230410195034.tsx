    ...
    <Pressable style={styles.container} onPress={handleToggleTickets}>
        ...
        
        {
            ticketsVisible && <View style={styles.tickets}>
                ...
                {
                    editVisible ? <PersonalInfoForm type='save' personalInfo={booking.personalinfo} id={booking._id}/> : <PersonalInformation personalInfo={booking.personalinfo} />
                }
