...
import { Pressable, StyleSheet, View,KeyboardAvoidingView, Touchable, TouchableOpacity, ScrollView } from 'react-native'
...
const styles = StyleSheet.create({
   ...
   messages:{
    ...
    right: 0,
    bottom: '15%',
    height: 200, // Change this value to adjust the height of the messages container
