    ...
    <Pressable style={styles.container} onPress={handleToggleTickets}>
        ...
        
        {
            ticketsVisible && <View style={styles.tickets}>
                ...
                {
                    editVisible ? <PersonalInfoForm personalInfo={booking.personalinfo}/> : <PersonalInformation personalInfo={booking.personalinfo} />
                }
                 ...
                 <FlatList 
                 data={booking.ticket}
                 renderItem={({item})=><Flights type='save' ticket={item}/>}/>
            </View>
        }
    </Pressable>
  )
