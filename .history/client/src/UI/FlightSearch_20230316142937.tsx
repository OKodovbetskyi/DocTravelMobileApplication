...
const FlightSearch : React.FC<Props> = () => {
  ...
  function toggelTripOption(option: string){
    setFlightQuery(prevState => ({
      ...prevState,
      tripOptions: {
        ...prevState.tripOptions,
        [option]: !prevState.tripOptions[option]
      }
  }))
}
  ...
  <View style={styles.container}>
    <View style={styles.row}>
      <TripOption tripOptionName='One Way' defOption={flightquery.tripOptions['oneWay']} handleSelect={toggelTripOption('oneWay')}/>
      <TripOption tripOptionName='Return' defOption={flightquery.tripOptions.return} handleSelect={toggelTripOption('return')}/>
    </View>
    <View style={styles.row} >
