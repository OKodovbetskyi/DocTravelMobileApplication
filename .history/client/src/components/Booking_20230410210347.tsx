    ...
    <Pressable style={styles.container} onPress={handleToggleTickets}>
        ...
        
        {
            ticketsVisible && <View style={styles.tickets}>
                ...
                {
                    editVisible ? <PersonalInfoForm type='save' personalInfo={booking.personalinfo} id={booking._id} load={load}/> : <PersonalInformation personalInfo={booking.personalinfo} />
                }
