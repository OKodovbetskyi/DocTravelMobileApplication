...
const FlightSearch : React.FC<Props> = () => {
  ...
  //Toggle trip oprions
  function toggelTripOption(name: string){
    setFlightQuery(prevState => ({
      ...prevState,
      tripOptions: {
        ...prevState.tripOptions,
        [name]: !prevState.tripOptions[name]
      }
  }))
}
  ...
  <View style={styles.container}>
    <View style={styles.row}>
      <TripOption tripOptionName='One Way' defOption={flightquery.tripOptions.oneWay}/>
      <TripOption tripOptionName='Return' defOption={flightquery.tripOptions.return}/>
    </View>
    <View style={styles.row} >
