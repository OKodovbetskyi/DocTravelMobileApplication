...
//   }, [flightquery.returnDate,flightquery.departureDate, flightquery.destination, flightquery.departure]);
  ...
  function handleSearch(city: string, variant: string){
    if (variant === 'departure'){
      dispatch(flightqueActions.setDepartureLocation(null))
    } else if (variant  === 'destination') {
      dispatch(flightqueActions.setDestinationLocation(null))
    }
  ...
  />
    ...
    <TextInput 
     ...
     onChangeText={(input)=>handleSearch(input,'departure')} 
     value={flightquery.destination != null ? flightquery.destination: flightquery.searchValue}/>    
    <FlatList
    ...
    setVisible={setVisible}>
    <TextInput placeholder='Enter city or airport' onChangeText={(input)=>handleSearch(input,'destination')} value={flightquery.departure != "" ? flightquery.departure: flightquery.searchValue}/>
{/* 
    {
