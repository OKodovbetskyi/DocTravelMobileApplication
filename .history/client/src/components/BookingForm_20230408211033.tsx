...
import {Text} from 'react-native-material'
const BookingForm = () => {
  ...
  return (
    ...
    <Text h4>Flight No: {}</Text>
    <Text h4>Destination: {}</Text>
    <Text h4>Departure Date: {}</Text>
    <Text h5>To Complete Booking, please enter your personal details</Text>
    <TextInput
      label="Full Name"
       />
     <TextInput
